...
class DrawSizePaperType extends StatefulWidget {
  ...
  // final Stream<QuerySnapshot<Map<String, dynamic>>> streamData;
  // ignore: prefer_typing_uninitialized_variables
  final controller;

  final String fileNameFirebase;
  const DrawSizePaperType(
      {Key? key,
  ...
  @override
  State<DrawSizePaperType> createState() => _DrawSizePaperTypeState();
}
                                      ...
                                      () => InkWell(
                                        ...
                                        child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                                ...
                                                border: Border.all(
                                                    width:
                                                        (widget.controller.optionNameSelected.value ==
                                                                widget
                                                                    .controller
                                                                    .list[index]
                                                                    .optionName)
                                                    ...
                                                    color: (widget
                                                                ...
                                                                .optionNameSelected
                                                                .value ==
                                                            widget.controller.list[index].optionName)
